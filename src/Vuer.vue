<template>
  <div>
    ...
    >
      ...
      <arrow @next-slide="next" @prev-slide="prev" :active-prev="activePrev" :active-next="activeNext" />
  ...
  export default {
    ...
    watch: {
      ...
      currentIndex() {
        ...
        this.activePrev = (this.currentIndex===0)?false:true;
        this.activeNext = (this.currentIndex===this.imgList.length-1)?false:true;
      },
      imgList() {
        let el = document.querySelector('.item-wrapper')
        el.translateX = -this.currentIndex * el.getBoundingClientRect().width
